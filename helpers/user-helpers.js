...
var instance = new Razorpay({
    key_id: 'rzp_test_YESO9NAygmaBn8',
    key_secret:'sTvz6mbByNRPPjDCfjIoYkNZ',
});
module.exports={
    doSignup:(userData)=>{
      ...
      verifyPayment:(details)=>{
        return new Promise((resolve,reject)=>{
            ...
            const crypto =require('crypto')
             let hmac =crypto.createHmac('sha256','sTvz6mbByNRPPjDCfjIoYkNZ')
